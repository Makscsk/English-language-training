			...
			<main class="main">
				...
				<div class="quiz__body">
					...
					<div style="margin-top: 20px; margin-left: 135px; display: flex; flex-direction: row;">
						<button id="back" type="submit" onmouseover="mBOver()" onmouseout="mBOut()" onclick="window.location.href = 'quiz8.php'">☚ Back ☚</button>
						
						<form method="POST" action="saveProg9.php" style="margin-left: 30px;">
							<button id="next" onclick="if(isTrue)" onmouseover="mNOver()" onmouseout="mNOut()" type="submit" >Завершить обучение</button>
						</form>
					</div>
				</div>				
			</main>
		</div>
		<script type="text/javascript" src="scripts/app9.js"></script>
