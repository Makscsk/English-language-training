			...
			<main class="main">
				...
				<div class="quiz__body">
					...
					<div style="margin-top: 20px; margin-left: 135px; display: flex; flex-direction: row;">
						<button id="back" type="submit" onclick="window.location.href = 'quiz2.php'" onmouseover="mBOver()" onmouseout="mBOut()">☚ Back ☚</button>
						<form method="POST" action="saveProg3.php" style="margin-left: 30px;">
