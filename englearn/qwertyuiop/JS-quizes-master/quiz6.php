...
<html>
	...
	<body>
			...
			<main class="main">
				...
				<div class="quiz__body">
					...
					<div style="margin-top: 20px; margin-left: 135px; display: flex; flex-direction: row;">
						<button id="back" type="submit" onmouseover="mBOver()" onmouseout="mBOut()" onclick="window.location.href = 'quiz5.php'">☚ Back ☚</button>
							
						<form method="POST" action="saveProg6.php" style="margin-left: 30px;">
		...
		<script type="text/javascript" src="scripts/app6.js"></script>
