...
const questions2 = 
[
	new Question("Выберите слово \"семья\"", 
	[
		new Answer("family 👪", 1),
		new Answer("son 👦", 0),
		new Answer("tree 🌳", 0),
	...
	new Question("Выберите слово \"игры\"", 
	[
		new Answer("union ☭", 0),
		new Answer("family 👪", 0),
		new Answer("games 🎮", 1),
	...
	new Question("Выберите слово \"питомец\"", 
	[
		new Answer("house 🏠", 0),
		new Answer("sister 👧", 0),
		new Answer("games 🎮", 0),
	...
	new Question("Выберите слово \"сын\"", 
	[
		new Answer("son 👦", 1),
		new Answer("family 👪", 0),
		new Answer("tree 🌳", 0),
	...
	new Question("Выберите слово \"дом\"", 
	[
		new Answer("pet 🐕", 0),
		new Answer("wife 👩", 0),
		new Answer("house 🏠", 1),
