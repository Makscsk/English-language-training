...
const questions2 = 
[
	new Question("Выберите слово \"очки\"", 
	[
		new Answer("cap 🧢", 0),
		new Answer("scarf 🧣", 0),
		new Answer("glasses 👓", 1),
		new Answer("boots 🥾", 0)
	]),

	new Question("Выберите слово \"платье\"", 
	[
		new Answer("cap 🧢", 0),
		new Answer("shirt 👕", 0),
		new Answer("bag 👜", 0),
	...
	[
		...
		new Answer("scarf 🧣", 1),
		new Answer("boots 🥾", 0),
		new Answer("glasses 👓", 0)
	]),

	new Question("Выберите слово \"сумка\"", 
	[
		new Answer("glasses 👓", 0),
		new Answer("shorts 🩳", 0),
		new Answer("shirt 👕", 0),
	...
	new Question("Выберите слово \"кепка\"", 
	[
		new Answer("cap 🧢", 1),
		new Answer("shirt 👕", 0),
		new Answer("scarf 🧣", 0),
	...
	new Question("Выберите слово \"шорты\"", 
	[
		new Answer("bag 👜", 0),
		new Answer("boots 🥾", 0),
		new Answer("dress 👗", 0),
