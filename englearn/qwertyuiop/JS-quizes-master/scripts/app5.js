...
const questions2 = 
[
	new Question("Выберите слово \"Париж\"", 
	[
		new Answer("Italy 🍕", 0),
		new Answer("USA 🗽", 0),
		new Answer("Japan 👘", 0),
	...
	new Question("Выберите слово \"Китай\"", 
	[
		new Answer("China 🐲", 1),
		new Answer("Czech 🍺", 0),
		new Answer("Belarus 🥔", 0),
		new Answer("USA 🗽", 0)
	]),

	new Question("Выберите слово \"Италия\"", 
	[
		new Answer("Italy 🍕", 1),
		new Answer("Paris 🗼", 0),
		new Answer("Holland 🍫", 0),
		new Answer("China 🐲", 0)
	]),

	new Question("Выберите слово \"США\"", 
	[
		new Answer("USA 🗽", 1),
		new Answer("Belarus 🥔", 0),
		new Answer("Japan 👘", 0),
	...
	new Question("Выберите слово \"Беларусь\"", 
	[
		new Answer("Holland 🍫", 0),
		new Answer("Czech 🍺", 0),
		new Answer("Belarus 🥔", 1),
		new Answer("China 🐲", 0)
	]),

	new Question("Выберите слово \"Япония\"", 
	[
		new Answer("Czech 🍺", 0),
		new Answer("Paris 🗼", 0),
		new Answer("Japan 👘", 1),
