...
const questions2 = 
[
	new Question("Выберите слово \"лягушка\"", 
	[
		new Answer("butterfly 🦋", 0),
		new Answer("frog 🐸", 1),
		new Answer("snail 🐌", 0),
		new Answer("mouse 🐁", 0)
	]),

	new Question("Выберите слово \"осьминог\"", 
	[
		new Answer("monkey 🐒", 0),
		new Answer("spider 🕷", 0),
		new Answer("frog 🐸", 0),
		new Answer("octopus 🐙", 1)
	]),

	new Question("Выберите слово \"кит\"", 
	[
		new Answer("butterfly 🦋", 0),
	...
	new Question("Выберите слово \"мышь\"", 
	[
		new Answer("whale 🐋", 0),
		new Answer("snail 🐌", 0),
		new Answer("mouse 🐁", 1),
	...
	new Question("Выберите слово \"бабочка\"", 
	[
		new Answer("butterfly 🦋", 1),
		new Answer("monkey 🐒", 0),
		new Answer("spider 🕷", 0),
		new Answer("whale 🐋", 0)
	]),

	new Question("Выберите слово \"паук\"", 
	[
		new Answer("mouse 🐁", 0),
		new Answer("spider 🕷", 1),
		new Answer("octopus 🐙", 0),
