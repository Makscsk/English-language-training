...
[
	...
	[
		new Answer("journey 🛬", 0),
		new Answer("knitting 🧶", 1),
		new Answer("sport 🥎", 0),
		new Answer("photographer 📷", 0)
	]),

	new Question("Выберите слово \"спорт\"", 
	[
		new Answer("painting 🎨", 0),
		new Answer("sport 🥎", 1),
		new Answer("dances 🕺", 0),
		new Answer("collector 🦋", 0)
	]),

	new Question("Выберите слово \"садоводство\"", 
	[
		new Answer("knitting 🧶", 0),
		new Answer("gardening 🌱", 1),
		new Answer("journey 🛬", 0),
		new Answer("painting 🎨", 0)
	]),

	new Question("Выберите слово \"фотограф\"", 
	[
		new Answer("gardening 🌱", 0),
		new Answer("collector 🦋", 0),
		new Answer("photographer 📷", 1),
		new Answer("knitting 🧶", 0)
	]),

	new Question("Выберите слово \"коллекционер\"", 
	[
		new Answer("dances 🕺", 0),
		new Answer("collector 🦋", 1),
		new Answer("gardening 🌱", 0),
		new Answer("photographer 📷", 0)
	]),

	new Question("Выберите слово \"рисование\"", 
	[
		new Answer("dances 🕺", 0),
		new Answer("sport 🥎", 0),
		new Answer("journey 🛬", 0),
		new Answer("painting 🎨", 1)
	])
];
