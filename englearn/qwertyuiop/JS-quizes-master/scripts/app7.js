...
const questions2 = 
[
	new Question("Выберите слово \"стул\"", 
	[
		new Answer("razor 🪒", 0),
		new Answer("toilet 🚽", 0),
		new Answer("vase 🏺", 0),
	...
	new Question("Выберите слово \"растение\"", 
	[
		new Answer("chair 🪑", 0),
		new Answer("knife 🔪", 0),
		new Answer("door 🚪", 0),
	...
	new Question("Выберите слово \"ваза\"", 
	[
		new Answer("plant 🌱", 0),
		new Answer("vase 🏺", 1),
		new Answer("toilet 🚽", 0),
	...
	new Question("Выберите слово \"бритва\"", 
	[
		new Answer("vase 🏺", 0),
		new Answer("chair 🪑", 0),
		new Answer("plant 🌱", 0),
	...
	new Question("Выберите слово \"туалет\"", 
	[
		new Answer("chair 🪑", 0),
		new Answer("toilet 🚽", 1),
		new Answer("vase 🏺", 0),
	...
	new Question("Выберите слово \"нож\"", 
	[
		new Answer("knife 🔪", 1),
		new Answer("plant 🌱", 0),
		new Answer("door 🚪", 0),
